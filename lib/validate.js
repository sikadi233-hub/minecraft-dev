...
/**
 * Derive the plugin.yml `api-version` value. Paper documents the field as the
 * API major version without the minor: "1.21.8" → "1.21", and the year-based
 * scheme "26.2" → "26" (valid values span 1.13 through the current major).
...
export function toApiVersion(minecraftVersion) {
  ...
  return major >= 26 ? String(major) : `${parts[0]}.${parts[1]}`
}
